    ...
    <>
      ...
      {timeOfDay === 1 && (
        <pointLight
          ...
          intensity={0.3} // Adjust intensity for better visibility at night
        />
      )}
      ...
      <group>
        <Desk position={[-0.2, -1.25, 1]} rotation={[0, 0.34, 0]} scale={[0.9, 0.6, 0.8]} />
        <Keyboard position={[-0.25, -0.9, 1.15]} rotation={[0, 0.35, 0]} scale={[0.09, 0.09, 0.09]} />
        <Mouse position={[0.1, -0.8, 1]} rotation={[0, 0.25, 0]} />
        <Chair position={[0.3, -1.1, 1.4]} rotation={[0, 1.95, 0]} scale={[0.8, 0.8, 0.8]} />
      </group>
      <group position={[0.2, -1.2, 1.7]} rotation={[-0.3, -2.65, -0.1]} scale={[0.8, 0.8, 0.8]}>
        <Avatar />
      </group>
      <Html position={[-2.8, 1.75, 0.55]}>
        <ActionButton top="20px" left="20px" onClick={handleDownloadCV} label="Resume 🔽" />
        <ActionButton top="90px" left="20px" onClick={handleMoveToInitialPosition} label="Initial Position ⏮️" />
        <ActionButton top="160px" left="20px" onClick={() => (window.location.href = "https://sksportfolio2d.netlify.app/")} label="2D site 🌐" />
      </Html>
      <Html position={[4, 3, 0.55]}>
        <ActionButton top="200px" left="20px" onClick={handleToggleDayNight} label={timeOfDay === 0 ? "Night 🌙" : "Day 🌞"} />
      </Html>
